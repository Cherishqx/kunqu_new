...
public class CalendarUtil {
    public static String getCyclical(){
        ...
        return c.cyclical()+"年"+c.getDay();
    }

    public static String getTwenty_tour(){
        Calendar ca = Calendar.getInstance();
        SolarTermsUtil s=new SolarTermsUtil(ca);
        return s.getSolartermsMsg();
    }

    public static String getHoliday(){
        Calendar ca = Calendar.getInstance();
        CalendarUtil c=new CalendarUtil(ca);
        return c.getChinaCalendarMsg(c.mLuchYear,c.mLuchMonth, c.mLuchDay);
    }
...
//		System.out.println((StringUtil.isNullOrEmpty(gre.getGremessage())?gre.getGremessage():gre.getGremessage()+"节  ")+"阳历"+getCurrentDay(ca)+"("+c.animalsYear()+"年 "+c.cyclical()+")");

        System.out.println("二十四节气："+s.getSolartermsMsg());
        System.out.println("节日："+gre.getGremessage());
        System.out.println("干支纪年："+c.cyclical());
        System.out.println("农历："+c.animalsYear());
        System.out.println("传统节日："+c.getChinaCalendarMsg(c.mLuchYear,c.mLuchMonth, c.mLuchDay));
        System.out.println("日期："+c.getDay(ca));
        System.out.println("农历："+c.getDay());
        System.out.println("星期："+c.getWeek(ca));
    ...
    public static String toDayStr(){
        ...
        sb.append("今天是")
                .append((StringUtil.isNullOrEmpty(gre.getGremessage())?gre.getGremessage():gre.getGremessage()+"节  ")+"阳历"+c.getCurrentDay(ca)+"("+c.animalsYear()+"年 "+c.cyclical()+")")
                .append(s.getSolartermsMsg()+c.getChinaCalendarMsg(c.mLuchYear,c.mLuchMonth, c.mLuchDay));
        return sb.toString();
    }

    public static String getJqOrChinaMsg(){
        Calendar ca = Calendar.getInstance();
        SolarTermsUtil s=new SolarTermsUtil(ca);
        CalendarUtil c=new CalendarUtil(ca);
        GregorianUtil gre=new GregorianUtil(ca);
        StringBuilder sb=new StringBuilder();
        sb.append(s.getSolartermsMsg()+c.getChinaCalendarMsg(c.mLuchYear,c.mLuchMonth, c.mLuchDay));
        return sb.toString();
    }
